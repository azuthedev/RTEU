    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div 
              className="bg-white rounded-lg shadow-xl w-full max-w-md mx-auto overflow-hidden max-h-[90vh] flex flex-col font-sans"
              onClick={(e) => e.stopPropagation()} // Stop propagation only for the modal content
            >
              <div className="flex items-center justify-between p-4 border-b">
                <h2 className="text-xl font-semibold font-serif">Cookie Settings</h2>
                <button
                  onClick={onClose}
              ...
              <div className="border-t p-4 flex flex-col sm:flex-row gap-3 justify-end">
                <button
                  onClick={onClose}
                  className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors sm:order-1 font-sans"
                >
                  Cancel
                </button>
                <button
                  onClick={acceptAll}
                  className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors sm:order-2 font-sans"
                >
                  Accept All
                </button>
                <button
                  onClick={savePreferences}
                  className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors sm:order-3 font-sans font-bold"
                >
                  Save Preferences
                </button>
              </div>
