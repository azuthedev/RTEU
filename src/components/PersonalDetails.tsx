  ...
  useEffect(() => {
    if (bookingState.personalDetails) {
      setFormData({
        ...
        pickup: bookingState.personalDetails.pickup || bookingState.from || '',
        dropoff: bookingState.personalDetails.dropoff || bookingState.to || ''
      });
    } else if (bookingState.from || bookingState.to) {
      setFormData(prev => ({
        ...prev,
        pickup: bookingState.from || '',
        dropoff: bookingState.to || ''
      }));
    }
  }, [bookingState.personalDetails, bookingState.from, bookingState.to]);
